...
# Remove the sidebar image since url_data is not defined

# Input Video Link
url = st.sidebar.text_input('Video URL', 'https://www.youtube.com/watch?v=RB3ks-FXYRw')

# Display Video and Title
from bs4 import BeautifulSoup
import requests

r = requests.get("https://www.youtube.com/watch?v=RB3ks-FXYRw")
...
st.sidebar.info(
        ...
        [#linkedin2]: https://www.linkedin.com/in/anishsoni/
        """
        )
    )
